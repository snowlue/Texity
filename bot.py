...
from game import (BACK_TO_MENU, CHANGE_OR_GO_TO_MENU_ARMY,
                  ...
                  CHANGE_OR_GO_TO_MENU_REMELTING, FOREIGN_POLICY, HIRE_ARMY,
                  HIRING, MARKET, MENU, OTHERS, POPULATION, PRODUCTIONS,
                  RESOURCES, STORAGES, SUCCESSFUL_BUILD, SUCCESSFUL_BUYING,
                  SUCCESSFUL_HIRING, SUCCESSFUL_REMELTING,
                  WAITING_FOR_CITY_NAME, WAITING_FOR_COUNT_OF_METAL,
                  WAITING_FOR_COUNT_TO_BUILD, WAITING_FOR_SUM_TO_BUY,
                  WAITING_FOR_TYPE_OF_BUILDING, WAITING_FOR_TYPE_OF_METAL,
                  attack, build_farms, build_gold_mines, build_houses,
                  build_iron_mines, build_others, build_productions,
                  build_quarries, build_sawmills, build_sieges, build_storages,
                  build_storages_food, build_storages_gold,
                  build_storages_gold_ore, build_storages_iron,
                  build_storages_iron_ore, build_storages_stone,
                  build_storages_wood, buy_food, buy_iron, buy_stone, buy_wood,
                  check_build, check_buy, check_hiring, check_remelt,
                  chose_type_of_buildings, con, cultivating, cur,
                  foreign_policy, get_info_about_city, get_info_about_opposite,
                  hire_army, hire_cavalry, hire_infantry, hire_spy,
